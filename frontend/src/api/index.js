...
export const pipelinesApi = {
  ...
  getAvailableInfluencers: (params) => api.get('/pipelines/influencers/available', { params }),
  checkInfluencer: (influencerId) => api.get(`/pipelines/influencer/${influencerId}/check`),
